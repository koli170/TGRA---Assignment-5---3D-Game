...
class Shader3D:
    def __init__(self):
        ...
        self.numLightsLoc = glGetUniformLocation(self.renderingProgramID, "u_num_lights")
        ...
        for i in range(10):
            self.lightPositionsLoc.append(glGetUniformLocation(self.renderingProgramID, f"u_light_positions[{i}]"))
            self.lightDiffuseLoc.append(glGetUniformLocation(self.renderingProgramID, f"u_light_diffuse[{i}]"))
            self.lightSpecularLoc.append(glGetUniformLocation(self.renderingProgramID, f"u_light_specular[{i}]"))
            self.lightAmbientLoc.append(glGetUniformLocation(self.renderingProgramID, f"u_light_ambient[{i}]"))
        ...
        self.matAmbientLoc = glGetUniformLocation(self.renderingProgramID, "u_mat_ambient")
        self.matShininessLoc = glGetUniformLocation(self.renderingProgramID, "u_mat_shininess")
        self.attenCheckLoc = glGetUniformLocation(self.renderingProgramID, "u_atten_check")
